...
export const NotificationCenter: React.FC<Props> = ({ userId, bare = false }) => {
  ...
  return (
    <TouchableOpacity
      ...
      style={bare ? [styles.bellButton, styles.bellButtonBare] : styles.bellButtonLineup}
      onPress={openPanel}
      activeOpacity={0.7}
...
const styles = StyleSheet.create({
  ...
  // Lineup header bell — 44x44 touch target, 4px padding, 24px icon, no fill
  // (transparent — just the white bell over the dark header).
  bellButtonLineup: {
    width: 44,
    height: 44,
    borderRadius: 24,
